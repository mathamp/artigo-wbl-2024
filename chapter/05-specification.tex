...
Outro exemplo, quando a configuração permitia que um dispositivo emitisse 2 \matheus{mensagens (eventos/comandos/ações)} num mesmo instante para outro dispositivo, um cenário irrelevante que o Maude exploraria seria a reemissão alternada destes eventos, que causaria um crescimento exponencial do espaço de busca.
