...
\matheus{Outro exemplo, quando a configuração permitia a emissão de 2 eventos num mesmo instante, um cenário irrelevante que o Maude exploraria seria a reemissão alternada destes eventos, que causaria um crescimento exponencial do espaço de busca.}
